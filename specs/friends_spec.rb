...
def test_getting_favourite_tv_show
  expected = "Baywatch"
  actual = getting_favourite_tv_show(@person2)
...
def test_adds_new_friends
  adds_new_friends(@person2, "Scrappy-Doo")
  expected = 2
...
def test_find_total_of_everyones_money
  expected = 143
  actual = find_total_of_everyones_money(@people)
  assert_equal(expected, actual)
end
